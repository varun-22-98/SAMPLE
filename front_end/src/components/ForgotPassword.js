                ...
                <div className="container-fluid pad2">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-5 offset-md-1 col-lg-5 col-xl-3 offset-xl-1 pad3  ">
                            ...
                            <button type="submit"className="btn btn-warning sub" onClick={onChangepassword}>Submit</button>
                        </div>
                        {/* <div className="col-12 col-md-5 offset-md-4 col-lg-5 col-xl-3 offset-xl-1 ">
